...
def main():
    device0 = Device(7,7)
    device0.add_ractangle_defect(5,5,1,1, clear_defect=False)
    device0.add_ractangle_defect(7,7,1,1, clear_defect=False)
    device0.add_ractangle_defect(9,9,1,1, clear_defect=False)

    device1 = Device(7,7)
    device1.add_ractangle_defect(5,5,1,1, clear_defect=False)
    ...
    device1.add_ractangle_defect(6,6,1,1, clear_defect=False)
    device1.add_ractangle_defect(8,6,1,1, clear_defect=False)
    device1.add_ractangle_defect(6,8,1,1, clear_defect=False)

    samples = sampler.sample(gen_tasks([device0, device1]))

    pickle.dump(samples, open('sp_data/bcmp3.pkl', 'wb'))
